...
import { listCpaAffiliateOfferReportForPublisher } from "@/services/cpa-offer.service";
...
export async function GET(request: Request) {
  return withAuth(async (session) => {
    try {
      ...
      const data = await listCpaAffiliateOfferReportForPublisher(session.user.id, {
        q: parsed.data.q,
